    ...
    positions: [
      {
        ...
        impact: [
          ...
          "Delivered the **Product Intelligence Platform**, the system of record **10+ SaaS product teams** ship against, defining each product's **L1 engagement** and L2 feature-adoption metrics: **1.2M+ daily events**, **70+ self-serving stakeholders**.",
          "Set the frequentist and Bayesian experimentation standard product teams make ship/kill calls with: a 5K-impression gate at **80% power**, and a **+16% qualification lift (58% to 74%)** that became the cross-sell proof point.",
          ...
          "Built the **3-layer warehouse** behind it: 4 parallel ELT services, reverse ETL into Salesforce and Gainsight; traced **80-90% of cost** to egress in a **Snowflake-to-BigQuery** review.",
        ],
        links: [
    ...
    positions: [
      {
        ...
        impact: [
          ...
          "Proved with a 27-variable regression that order stacking loses money past a **20-24% band**, shipped as the **national dispatch policy**.",
        ],
