    ...
    positions: [
      {
        ...
        period: "2026 - present",
        impact: [
          "Sole product owner across **4 squads with no engineer** for a B2B2C marketplace moving **16K households a month** on energy, broadband and insurance referral commission.",
          ...
          "Instrumented Service Ops in HubSpot, built in-house at **£0 spend**: **11 AI workflows** now run the queue, classifying **76K tickets a year** at **94% precision** with **83% closing with no agent reply**, **2.8× the moves** at flat headcount.",
          "Authored the agent **SOP inside HubSpot**: **12 articles** of know-how, edge cases and resolutions, with agentic triage over it: **17.9K supplier emails** auto-classified this year, **235** reaching a human.",
          "Founded WorkOS, the agentic operating layer behind **6 job functions**: Claude wired to **15+ production systems** for user-acceptance testing, bug triage, data pipelines and the reporting **every function** runs on, **Call Ops** included, with SSO-gated dashboards replacing enterprise BI.",
        ],
