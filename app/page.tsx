    ...
    positions: [
      {
        ...
        period: "2026 - present",
        impact: [
          "Sole product owner across **4 delivery squads** for a B2B2C marketplace moving **16K households a month** on energy, broadband and insurance referral commission, with no dedicated engineer.",
          ...
          "Instrumented Service Ops in HubSpot, built in-house at **£0 spend**: **11 workflows** classify **76K tickets a year** at **94% precision**, **83% closing with no agent reply**, **2.8× the moves** at flat headcount.",
          "Wrote the **12-article knowledge base** agents work from, then layered agentic triage over it: **17.9K supplier emails** auto-classified this year, **235** needing a human.",
          "Founded WorkOS, the agentic operating layer behind **6 job functions**: Claude wired to **15+ production systems** for shift briefings, user-acceptance testing, bug triage, data pipelines and Call Ops reporting, with SSO-gated dashboards replacing enterprise BI.",
        ],
