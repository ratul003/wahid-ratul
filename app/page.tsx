    ...
    positions: [
      {
        ...
        impact: [
          ...
          "Turned Service Ops' 28-tab spreadsheet into an in-house ticketing product on HubSpot: **11 AI workflows** run the queue, classifying 76K tickets/yr at 94% precision with **83% closing with no agent reply**; 9 agents absorb **2.8× the moves** at flat headcount.",
