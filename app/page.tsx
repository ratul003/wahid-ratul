    ...
    positions: [
      {
        ...
        impact: [
          ...
          "Instrumented Service Ops in HubSpot, built in-house at **£0 spend**: **11 AI workflows** run the queue over a **12-article agent SOP** of know-how, edge cases and resolutions, classifying **76K tickets a year** at **94% precision**, **83% closing with no agent reply**, and **17.9K supplier emails** auto-triaged with **235** reaching a human, **2.8× the moves** at flat headcount.",
