    ...
    positions: [
      {
        ...
        impact: [
          ...
          "Founded WorkOS, the agentic operating layer behind **6 job functions**: Claude wired to **15+ production systems** for user-acceptance testing, bug triage, data pipelines and the reporting **every function** runs on, with SSO-gated dashboards replacing enterprise BI.",
        ],
